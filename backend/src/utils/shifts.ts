...
export const afternoonTimelines = [
...
export const shifts = {
    morning: morningTimelines,
    afternoon: afternoonTimelines,
    evening: eveningTimelines
}