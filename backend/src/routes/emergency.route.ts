...
import { createEmergencySchema, getEmergencySchema, updateEmergencySchema } from '../schema/emergency.schema';
...
router.route('/:id').get(verifyRole(['doctor', 'staff']), validateResource(getEmergencySchema), getEmergencyController).patch(verifyRole(['doctor','staff']), validateResource(updateEmergencySchema), updateEmergencyController)
